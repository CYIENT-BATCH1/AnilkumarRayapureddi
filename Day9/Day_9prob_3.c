...
1.SWITCH STATUS WE assign hexa decimal value
2.Take all fault conditions and assign some values
3.give the values as user inputs
4.In fault type1 we print the values of reg0 bit 0 and bit 1 ,reg1 print all bits and reg2 print bit 4 and bit 5 with out disturbing other bits.*/
